const fetchunsplash = async () => {
    const chave_api_unsplash = "TPEbPt9EMbLvZEXMUqYhNiCVtugoti_-B_-Fi_S1VC0";
    const query = ["mar", "natureza", "oceano", "praia", "animais", "flores", "florestas", "paisagens", "dunas", "beleza", "cidades", "montanhas", "dia", "noite"];
